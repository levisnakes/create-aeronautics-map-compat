...
public final class ClientEvents {
    /** Guards so the compat classes are only classloaded when the Xaero mods exist. */
    ...
    private static void leaveWorld() {
        // The element renderer reads live tracker state, so clearing the trackers
        // is all that's needed - no Xaero-side cleanup.
        ShipTracker.reset();
